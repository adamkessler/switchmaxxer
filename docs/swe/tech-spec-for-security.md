...
- a local CLI
- a local MCP surface
- an HTTP gateway that reverse-proxies LLM API requests to configured upstream model providers

The codebase is not a browser application, not a public multi-tenant SaaS, and not a general-purpose web reverse proxy. Its proxy role is limited to configured LLM routes and upstream providers.
...
and [src/subsystems/hot-path/manatee/runtime/local-gateway-auth.ts](../../src/subsystems/hot-path/manatee/runtime/local-gateway-auth.ts).
...
[`gatewayRequestSourceIp`](../../src/subsystems/hot-path/manatee/runtime/runtime-helpers.ts).
Gateway request limiting uses
[`gatewayRateLimitKey`](../../src/subsystems/hot-path/manatee/runtime/runtime-helpers.ts), which
...
- [src/subsystems/hot-path/manatee/proxy/http-transport.ts](../../src/subsystems/hot-path/manatee/proxy/http-transport.ts)
- [src/subsystems/hot-path/manatee/proxy/proxy-forwarding.ts:225](../../src/subsystems/hot-path/manatee/proxy/proxy-forwarding.ts#L225)
...
Provider auth is resolved per route with explicit misconfiguration handling in [src/subsystems/config/provider-auth.ts](../../src/subsystems/config/provider-auth.ts) and [src/subsystems/hot-path/manatee/proxy/proxy-core.ts](../../src/subsystems/hot-path/manatee/proxy/proxy-core.ts).
...
- [src/subsystems/hot-path/manatee/proxy/proxy-response-handlers.ts](../../src/subsystems/hot-path/manatee/proxy/proxy-response-handlers.ts)
...
- [src/subsystems/observability/ostrich/ingestion/gateway-observation-records.ts](../../src/subsystems/observability/ostrich/ingestion/gateway-observation-records.ts)
- [src/subsystems/observability/gateway-observation-runtime-state.ts](../../src/subsystems/observability/gateway-observation-runtime-state.ts)
  public facade backed by
  [src/subsystems/observability/ostrich/ingestion/gateway-observation-runtime-state.ts](../../src/subsystems/observability/ostrich/ingestion/gateway-observation-runtime-state.ts)
- [src/subsystems/observability/ostrich/ingestion/gateway-observation-priority.ts](../../src/subsystems/observability/ostrich/ingestion/gateway-observation-priority.ts)
- [src/subsystems/observability/gateway-observation-queue.ts](../../src/subsystems/observability/gateway-observation-queue.ts)
  public facade backed by
  [src/subsystems/observability/ostrich/ingestion/gateway-observation-queue.ts](../../src/subsystems/observability/ostrich/ingestion/gateway-observation-queue.ts)
- [src/subsystems/observability/gateway-observation-flush.ts](../../src/subsystems/observability/gateway-observation-flush.ts)
  public facade backed by
  [src/subsystems/observability/ostrich/ingestion/gateway-observation-flush.ts](../../src/subsystems/observability/ostrich/ingestion/gateway-observation-flush.ts)
- [src/subsystems/observability/gateway-observation-shutdown.ts](../../src/subsystems/observability/gateway-observation-shutdown.ts)
  public facade backed by
  [src/subsystems/observability/ostrich/ingestion/gateway-observation-shutdown.ts](../../src/subsystems/observability/ostrich/ingestion/gateway-observation-shutdown.ts)
- [src/subsystems/observability/gateway-observation-worker.ts](../../src/subsystems/observability/gateway-observation-worker.ts)
  public facade backed by
  [src/subsystems/observability/ostrich/ingestion/gateway-observation-worker.ts](../../src/subsystems/observability/ostrich/ingestion/gateway-observation-worker.ts)
...
- [src/subsystems/hot-path/manatee/runtime/local-gateway-auth.ts](../../src/subsystems/hot-path/manatee/runtime/local-gateway-auth.ts)
...
- [src/subsystems/hot-path/manatee/runtime/auth-rate-limit.ts](../../src/subsystems/hot-path/manatee/runtime/auth-rate-limit.ts)
...
- [src/subsystems/observability/ostrich/query/repository.ts](../../src/subsystems/observability/ostrich/query/repository.ts)
...
- [src/subsystems/hot-path/manatee/runtime/rate-limit.ts](../../src/subsystems/hot-path/manatee/runtime/rate-limit.ts)
