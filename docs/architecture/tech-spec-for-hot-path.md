...
- [src/subsystems/hot-path/manatee/runtime/runtime-helpers.ts](../../src/subsystems/hot-path/manatee/runtime/runtime-helpers.ts) —
...
- [src/subsystems/hot-path/manatee/runtime/rate-limit.ts](../../src/subsystems/hot-path/manatee/runtime/rate-limit.ts) +
  [runtime-rate-limits.ts](../../src/subsystems/hot-path/manatee/runtime/runtime-rate-limits.ts) +
  [window-rotation.ts](../../src/subsystems/hot-path/manatee/runtime/window-rotation.ts) —
  global per-caller request-rate limiter and rolling time windows.
- [src/subsystems/hot-path/manatee/runtime/runtime-state-managers.ts](../../src/subsystems/hot-path/manatee/runtime/runtime-state-managers.ts) —
  concurrency caps for in-flight JSON parses and per-IP streaming requests.
- [src/subsystems/hot-path/manatee/runtime/request-dispatch.ts](../../src/subsystems/hot-path/manatee/runtime/request-dispatch.ts) —
  the request-body read, JSON parse, shape validation, and dialect dispatch.
- [src/subsystems/hot-path/manatee/runtime/http-runtime-helpers.ts](../../src/subsystems/hot-path/manatee/runtime/http-runtime-helpers.ts) —
  `readRequestBodyWithLimit` async-iterator body reader with idle/total
  timeouts.
- [src/subsystems/hot-path/manatee/runtime/request-body-types.ts](../../src/subsystems/hot-path/manatee/runtime/request-body-types.ts) —
  `validateGatewayProxyRequestBody` shape validators for OpenAI and Anthropic
  inbound shapes.
- [src/subsystems/hot-path/manatee/proxy/proxy.ts](../../src/subsystems/hot-path/manatee/proxy/proxy.ts) — the
...
- [src/subsystems/hot-path/manatee/proxy/proxy-anthropic.ts](../../src/subsystems/hot-path/manatee/proxy/proxy-anthropic.ts) +
  [proxy-openai.ts](../../src/subsystems/hot-path/manatee/proxy/proxy-openai.ts) — listener-side
...
- [src/subsystems/hot-path/manatee/proxy/proxy-response-buffer.ts](../../src/subsystems/hot-path/manatee/proxy/proxy-response-buffer.ts) +
  [proxy-response-handlers.ts](../../src/subsystems/hot-path/manatee/proxy/proxy-response-handlers.ts) —
  the buffered (non-streaming) upstream reader with byte caps, and the
  buffered-response delivery path.
- [src/subsystems/hot-path/manatee/proxy/proxy-request-shape.ts](../../src/subsystems/hot-path/manatee/proxy/proxy-request-shape.ts) +
  [proxy-upstream-model.ts](../../src/subsystems/hot-path/manatee/proxy/proxy-upstream-model.ts) —
...
- [src/subsystems/hot-path/manatee/proxy/upstream-url.ts](../../src/subsystems/hot-path/manatee/proxy/upstream-url.ts) —
...
2. **`requestHandler` from
   ...
   `src/subsystems/hot-path/manatee/runtime/runtime-request-handler.ts`** is invoked with the
...
- **Outputs:** stringified body in dialect B, plus per-stream translator
  state for SSE.
- **Surface:** [proxy-translation.ts](../../src/subsystems/hot-path/manatee/proxy/proxy-translation.ts).
...
- **Surface:** [proxy-streaming.ts](../../src/subsystems/hot-path/manatee/proxy/proxy-streaming.ts).
...
- **Surface:**
  [src/subsystems/observability/gateway.ts](../../src/subsystems/observability/gateway.ts) +
  [gateway-observation-records.ts](../../src/subsystems/observability/ostrich/ingestion/gateway-observation-records.ts) +
  [gateway-observation-runtime-state.ts](../../src/subsystems/observability/gateway-observation-runtime-state.ts) +
  [gateway-observation-priority.ts](../../src/subsystems/observability/ostrich/ingestion/gateway-observation-priority.ts) +
...
- **Streaming bodies.** The translation streaming relay is the most
  ...
  not. Tests like
  [proxy-runtime.anthropic-streaming.test.ts](../../src/subsystems/hot-path/manatee/proxy/proxy-runtime.anthropic-streaming.test.ts)
