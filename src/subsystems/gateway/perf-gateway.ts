...
import type { ProxyRequest, ProxyResponse } from "../hot-path/manatee/proxy/proxy";
import { proxyChatCompletion } from "../hot-path/manatee/proxy/proxy";
...
import { defaultObservabilityModule } from "../observability/observability-module";
...
export async function runScenario(name: string, options: {
  ...
  defaultObservabilityModule.configure({
    retentionOlderThan: null,
