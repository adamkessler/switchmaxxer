...
} from "../hot-path/manatee/runtime/runtime-state-managers";
import { runGatewayServerLifecycle } from "./gateway-runner";
import { createGatewayRuntimeRateLimiter } from "../hot-path/manatee/runtime/runtime-rate-limits";
import { createGatewayRuntimeRequestHandler } from "../hot-path/manatee/runtime/runtime-request-handler";
import {
...
} from "../hot-path/manatee/runtime/runtime-snapshot";
      ...
      beginGracefulShutdown: (
        ...
        const shutdownResult = beginGatewayGracefulShutdown({
          ...
          finalizeShutdown: async () => {
            removeProcessHandlers();
            await deps.observabilityModule.shutdown();
          },
