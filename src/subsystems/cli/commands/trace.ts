...
import { createTraceReadCommands, type TraceObservabilityHandle } from "./trace/read-commands";
...
export function createTraceCli(deps: {
  ...
  function getHelpText(): string {
    return buildHelpText({
      ...
      docsPath: "docs/subsystems/observability/tech-spec-for-observation-semantics.md",
