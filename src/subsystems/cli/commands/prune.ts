...
import type { ObservabilityRetentionPort } from "../../observability/observability-module";
...
export function runObservabilityPruneCommand(
  ...
  try {
    ...
    const pruneResult = deps.retention.pruneOlderThan({
      dbPath,
      cutoffIso: cutoffAt
    });
...
Docs:
  docs/subsystems/observability/store/tech-spec-for-observability-store-implementation.md
