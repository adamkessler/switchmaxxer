...
export function createGatewayBootstrap(deps: {
  ...
  buildLocalGatewayAuthHeaders: typeof import("../hot-path/manatee/runtime/local-gateway-auth").buildLocalGatewayAuthHeaders;
  resolveLocalGatewayInboundAuthState: typeof import("../hot-path/manatee/runtime/local-gateway-auth").resolveLocalGatewayInboundAuthState;
  timingSafeTokenMatches: typeof import("../hot-path/manatee/runtime/local-gateway-auth").timingSafeTokenMatches;
  proxyAnthropicMessage: typeof import("../hot-path/manatee/proxy/proxy").proxyAnthropicMessage;
  proxyChatCompletion: typeof import("../hot-path/manatee/proxy/proxy").proxyChatCompletion;
  sendJsonError: typeof import("../hot-path/manatee/proxy/proxy").sendJsonError;
  readRequestBodyWithLimit: typeof import("../hot-path/manatee/runtime/http-runtime-helpers").createGatewayHttpRuntimeHelpers extends (
    ...args: never[]
  ) => infer R
    ? R extends { readRequestBodyWithLimit: infer T }
      ...
      : never
    : never;
  validateParsedRequestBodyShape: typeof import("../hot-path/manatee/runtime/http-runtime-helpers").createGatewayHttpRuntimeHelpers extends (
    ...args: never[]
  ) => infer R
  ...
  observabilityModule: import("../observability/observability-module").ObservabilityModule;
  ...
  runRouteTestsDetailed: typeof import("../hot-path/manatee/proxy/proxy").runRouteTestsDetailed;
  ...
  const gatewayRuntime = createGatewayRuntime({
    ...
    observabilityModule: deps.observabilityModule,
